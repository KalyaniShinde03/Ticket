          ...
          <div className='col-md-6 col-lg-4'>
            <Card  style={{ height: 'auto' }}>
              <div>
                ...
                <div className='card-body pt-0 shadow pt-2'>
                  <form onSubmit={handleSubmit}>
                    <img src={user} className="img-fluid mx-auto d-block" style={{ height: '80px', width: '80px' }} />
                    ...
                    <div className='row'>
                      <div className='col-12 text-center'>
                        <Button variant="outline-info " type='submit' onClick={login}><b>Login</b></Button>
