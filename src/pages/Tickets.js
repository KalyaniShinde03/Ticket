...
import {
    getTicket, addTicket, getDeptList, getTicketById, getNewTickets,
    getAssignedTickets, GetEmployeesByDeptId, getAssignRequest, startTicket, closeTicket
} from '../services/Api'
const Tickets = () => {
            ...
            <div className='container-fluid'>
                <div className='row'>
                    <div className='col-lg-12 col-md-12'>
                        <div className="card">
                            <div className="card-header  text-white" style={{backgroundColor:'#263F4E'}}>
                                <div className="row">
